...
public class IabHelper {
	 ...
	 * the result will be delivered via the activity's {@link Activity#onActivityResult} method, at which point you must call this object's {@link #handleActivityResult} method to continue the purchase flow. This method MUST be
	...
	/**
	 * Handles an activity result that's part of the purchase flow in in-app billing. If you are calling {@link #launchPurchaseFlow}, then you must call this method from your Activity's {@link Activity@onActivityResult} method.
